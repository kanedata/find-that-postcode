...
OTHER_CODES = {
    ...
    "imd": {
        ...
        "E92000001-simd2020": 33755,
        "W92000004-simd2020": 1909,
        "S92000003-simd2020": 6976,
        "N92000002-simd2020": None,
...
STATS_FIELDS = [
    ...
    Field(
        id="simd2020_rank",
        name="Scottish Index of Multiple Deprivation (2020) rank",
        location="stats.simd2020.simd_rank",
        area="lsoa11",
    ),
    Field(
        id="simd2020_decile",
        name="Scottish Index of Multiple Deprivation (2020) decile",
        location="stats.simd2020.simd_decile",
        area="lsoa11",
    ),
    # Field(
    #   id="popn2015",
...
OAC11_CODE: dict[str, tuple[str, str, str]] = {
