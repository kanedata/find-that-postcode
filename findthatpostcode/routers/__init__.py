...
# from findthatpostcode.routers.auth import router as auth_router
...
from findthatpostcode.routers.subscriptions import router as subscriptions_router
from findthatpostcode.security import api_key_scheme, oauth2_scheme

# Create two routers: one for authenticated endpoints and one for public endpoints
router = APIRouter(dependencies=[Depends(api_key_scheme), Depends(oauth2_scheme)])
